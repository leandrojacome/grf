...
(
    ...
    TAXA_EFETIVA_NEGOCIACAO             DECIMAL(10,2)       NULL,
    ...
    PU_AGIO_DESAGIO                     DECIMAL(10,2)       NULL,
    VALOR_FINANCEIRO                    DECIMAL(10,2)       NOT NULL,
    VALOR_FINANCEIRO_AGIO_DESAGIO       DECIMAL(10,2)       NULL,
    VALOR_FINANCEIRO_NEGOCIACAO         DECIMAL(10,2)       NULL,
    ...
    CONSTRAINT OPERACAO_RENDA_FIXA_DEFINITIVA_INDICE_FK_INDICADOR_FINANCEIRO FOREIGN KEY (INDICE) REFERENCES GESTAO_RECURSOS_FINANCEIROS.INDICADOR_FINANCEIRO(ID),
    CONSTRAINT OPERACAO_RENDA_FIXA_DEFINITIVA_INDICE_NEGOCIACAO_FK_INDICADOR_FINANCEIRO FOREIGN KEY (INDICE_NEGOCIACAO) REFERENCES GESTAO_RECURSOS_FINANCEIROS.INDICADOR_FINANCEIRO(ID),
    ...
    CONSTRAINT CHECK_TAXA CHECK (TIPO_TAXA != 'PRE' OR (TIPO_TAXA = 'PRE' AND TAXA IS NOT NULL)),
    CONSTRAINT CHECK_TAXA_EFETIVA CHECK (TIPO_TAXA != 'PRE' OR (TIPO_TAXA = 'PRE' AND TAXA_EFETIVA IS NOT NULL)),
    CONSTRAINT CHECK_TAXA_PRE CHECK (TIPO_MERCADO != 'MERCADO_SECUNDARIO' OR (TIPO_MERCADO = 'MERCADO_SECUNDARIO' AND TIPO_TAXA IN('PRE','PRE_POS') AND TAXA_PRE IS NOT NULL)),
    CONSTRAINT CHECK_TAXA_NEGOCIACAO CHECK (TIPO_MERCADO != 'MERCADO_SECUNDARIO' OR (TIPO_MERCADO = 'MERCADO_SECUNDARIO' AND (TIPO_TAXA != 'PRE' OR TIPO_TAXA = 'PRE' AND TAXA_NEGOCIACAO IS NOT NULL))),
    CONSTRAINT CHECK_TAXA_EFETIVA_NEGOCIACAO CHECK (TIPO_MERCADO != 'MERCADO_SECUNDARIO' OR (TIPO_MERCADO = 'MERCADO_SECUNDARIO' AND (TIPO_TAXA != 'PRE' OR TIPO_TAXA = 'PRE' AND TAXA_EFETIVA_NEGOCIACAO IS NOT NULL))),
    CONSTRAINT CHECK_TAXA_PRE_NEGOCIACAO CHECK (TIPO_MERCADO != 'MERCADO_SECUNDARIO' OR (TIPO_MERCADO = 'MERCADO_SECUNDARIO' AND TIPO_TAXA IN('PRE','PRE_POS') AND TAXA_PRE_NEGOCIACAO IS NOT NULL)),
    CONSTRAINT CHECK_INDICE CHECK (TIPO_TAXA NOT IN('POS','PRE_POS') OR (TIPO_TAXA IN('POS','PRE_POS') AND INDICE IS NOT NULL)),
    CONSTRAINT CHECK_INDICE_NEGOCIACAO CHECK (TIPO_MERCADO != 'MERCADO_SECUNDARIO' OR (TIPO_MERCADO = 'MERCADO_SECUNDARIO' AND TIPO_TAXA IN('POS','PRE_POS') AND INDICE_NEGOCIACAO IS NOT NULL)),
    ...
    CONSTRAINT CHECK_PERCENTUAL_NEGOCIACAO CHECK (TIPO_TAXA NOT IN('POS','PRE_POS') OR (TIPO_TAXA IN('POS','PRE_POS') AND PERCENTUAL_NEGOCIACAO IS NOT NULL)),
    CONSTRAINT CHECK_PU_AGIO_DESAGIO CHECK (TIPO_MERCADO != 'MERCADO_SECUNDARIO' OR (TIPO_MERCADO = 'MERCADO_SECUNDARIO' AND PU_AGIO_DESAGIO IS NOT NULL)),
    CONSTRAINT CHECK_VALOR_FINANCEIRO_AGIO_DESAGIO CHECK (TIPO_MERCADO != 'MERCADO_SECUNDARIO' OR (TIPO_MERCADO = 'MERCADO_SECUNDARIO' AND VALOR_FINANCEIRO_AGIO_DESAGIO IS NOT NULL)),
    CONSTRAINT CHECK_VALOR_FINANCEIRO_NEGOCIACAO CHECK (TIPO_MERCADO != 'MERCADO_SECUNDARIO' OR (TIPO_MERCADO = 'MERCADO_SECUNDARIO' AND VALOR_FINANCEIRO_NEGOCIACAO IS NOT NULL)),
...
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA.TAXA_EFETIVA_NEGOCIACAO
