...
(
    ...
    CONSTRAINT CHECK_SECUNDARIO_DIAS_UTEIS_TAXA_PRE    CHECK (TIPO_TAXA = 'POS' OR (TIPO_TAXA IN('PRE','PRE_POS') AND ( DIAS_UTEIS_TAXA_PRE = 0 OR DIAS_UTEIS_TAXA_PRE = 1 ))),
    ...
    CONSTRAINT CHECK_SECUNDARIO_DIAS_UTEIS_INDICE      CHECK (TIPO_TAXA = 'PRE' OR (TIPO_TAXA IN('POS','PRE_POS') AND ( DIAS_UTEIS_INDICE = 0 OR DIAS_UTEIS_INDICE = 1 ))),
