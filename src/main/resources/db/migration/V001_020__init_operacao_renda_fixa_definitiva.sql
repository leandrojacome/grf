...
(
    ...
    OPERACAO_GIF_CODIGO                 NUMBER              NULL,
...
(
    ...
    CONSTRAINT CHECK_DIAS_UTEIS_TAXA_PRE CHECK (TIPO_TAXA = 'POS' OR (TIPO_TAXA IN('PRE','PRE_POS') AND ( DIAS_UTEIS_TAXA_PRE IS NOT NULL AND (DIAS_UTEIS_TAXA_PRE = 0 OR DIAS_UTEIS_TAXA_PRE = 1 )))),
    ...
    CONSTRAINT CHECK_DIAS_UTEIS_INDICE CHECK (TIPO_TAXA = 'PRE' OR (TIPO_TAXA IN('POS','PRE_POS') AND ( DIAS_UTEIS_INDICE IS NOT NULL AND (DIAS_UTEIS_INDICE = 0 OR DIAS_UTEIS_INDICE = 1 ))))
) TABLESPACE GESTAO_RECURSOS_FINAN_DATA;
...
(
    ...
    CONSTRAINT CHECK_SECUNDARIO_TAXA_PRE               CHECK (TIPO_TAXA = 'POS' OR (TIPO_TAXA IN('PRE','PRE_POS') AND TAXA_PRE IS NOT NULL)),
    CONSTRAINT CHECK_SECUNDARIO_DIAS_UTEIS_TAXA_PRE    CHECK (TIPO_TAXA = 'POS' OR (TIPO_TAXA IN('PRE','PRE_POS') AND ( DIAS_UTEIS_TAXA_PRE IS NOT NULL AND (DIAS_UTEIS_TAXA_PRE = 0 OR DIAS_UTEIS_TAXA_PRE = 1 )))),
    CONSTRAINT CHECK_SECUNDARIO_TAXA_EFETIVA           CHECK (TIPO_TAXA = 'POS' OR (TIPO_TAXA IN('PRE','PRE_POS') AND TAXA_EFETIVA IS NOT NULL)),
    ...
    CONSTRAINT CHECK_DIAS_UTEIS_TAXA_PRE_NEGOCIACAO CHECK (TIPO_TAXA = 'POS' OR (TIPO_TAXA IN('PRE','PRE_POS') AND ( DIAS_UTEIS_TAXA_PRE_NEGOCIACAO IS NOT NULL AND (DIAS_UTEIS_TAXA_PRE_NEGOCIACAO = 0 OR DIAS_UTEIS_TAXA_PRE_NEGOCIACAO = 1 )))),
    CONSTRAINT CHECK_SECUNDARIO_INDICE                 CHECK (TIPO_TAXA = 'PRE' OR (TIPO_TAXA IN('POS','PRE_POS') AND INDICE IS NOT NULL)),
    CONSTRAINT CHECK_SECUNDARIO_PERCENTUAL_INDICE      CHECK (TIPO_TAXA = 'PRE' OR (TIPO_TAXA IN('POS','PRE_POS') AND PERCENTUAL_INDICE IS NOT NULL)),
    CONSTRAINT CHECK_SECUNDARIO_DIAS_UTEIS_INDICE      CHECK (TIPO_TAXA = 'PRE' OR (TIPO_TAXA IN('POS','PRE_POS') AND ( DIAS_UTEIS_INDICE IS NOT NULL AND (DIAS_UTEIS_INDICE = 0 OR DIAS_UTEIS_INDICE = 1 )))),
    ...
    CONSTRAINT CHECK_DIAS_UTEIS_INDICE_NEGOCIACAO CHECK (TIPO_TAXA = 'PRE' OR (TIPO_TAXA IN('POS','PRE_POS') AND ( DIAS_UTEIS_INDICE_NEGOCIACAO IS NOT NULL AND (DIAS_UTEIS_INDICE_NEGOCIACAO = 0 OR DIAS_UTEIS_INDICE_NEGOCIACAO = 1 ))))
) TABLESPACE GESTAO_RECURSOS_FINAN_DATA;
...
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_PRIMARIO.DIAS_UTEIS_TAXA_PRE
...
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_PRIMARIO.DIAS_UTEIS_INDICE
    IS 'Dias uteis para o indice, valido para TIPO_TAXA igual a POS ou PRE-POS';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_PRIMARIO.PU_EMISSAO
    IS 'Valor PU emissão';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_PRIMARIO.VALOR_RESGATE
    IS 'Valor resgate';
...
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.TIPO_TAXA
    IS 'Tipo de taxa PRE, POS, PRE-POS';
COMMENT
...
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.DIAS_UTEIS_TAXA_PRE
    IS 'Dias uteis para taxa , valido para TIPO_TAXA igual a PRE ou PRE-POS';
COMMENT
...
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.DIAS_UTEIS_TAXA_PRE_NEGOCIACAO
    IS 'Dias uteis para taxa pre de negociaçao, valido para TIPO_TAXA igual a PRE ou PRE-POS';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.INDICE
    IS 'Indice (Indicador Financeiro), valido para TIPO_TAXA igual a POS ou PRE-POS';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.PERCENTUAL_INDICE
    IS 'Valor em percentual do campo indice, valido para TIPO_TAXA igual a POS ou PRE-POS';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.DIAS_UTEIS_INDICE
    IS 'Dias uteis para o indice, valido para TIPO_TAXA igual a POS ou PRE-POS';
COMMENT
...
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.DIAS_UTEIS_INDICE_NEGOCIACAO
    IS 'Dias uteis para o indice de negociacao, valido para TIPO_TAXA igual a POS ou PRE-POS';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.PU_ATUAL
    IS 'PU atual';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.PU_NEGOCIADO
    IS 'PU negociado';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.PU_POUPEX
    IS 'PU poupex';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.PU_CONTRAPARTE
    IS 'PU contraparte';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.VALOR_FINANCEIRO_ATUAL
    IS 'Valor financeiro atual';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.VALOR_FINANCEIRO_NEGOCIADO
    IS 'Valor financeiro atual';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.VALOR_FINANCEIRO_POUPEX
    IS 'Valor financeiro poupex';
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_RENDA_FIXA_DEFINITIVA_SECUNDARIO.VALOR_FINANCEIRO_CONTRAPARTE
    IS 'Valor financeiro contraparte';
