...
(
    ...
    CONSTRAINT FUNDOS_INVESTIMENTOS_PK PRIMARY KEY (ID) USING INDEX ENABLE,
    CONSTRAINT FUNDOS_INVESTIMENTOS_ID_FK_INSTRUMENTO_FINANCEIRO FOREIGN KEY (ID) REFERENCES GESTAO_RECURSOS_FINANCEIROS.INSTRUMENTO_FINANCEIRO(ID),
