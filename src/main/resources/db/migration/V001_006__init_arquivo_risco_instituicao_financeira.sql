...
(
    ...
    CAMINHO                         VARCHAR2(128)   NOT NULL,
    CONSTRAINT INSTITUICAO_FINANCEIRA_RISCO_ARQUIVO_PK  PRIMARY KEY (INSTITUICAO_FINANCEIRA_RISCO) ENABLE,
...
COMMENT
    ...
    IS 'Identificador único. um-para-um com INSTITUICAO_FINANCEIRA_RISCO.';
COMMENT
