...
(
    ...
    CONSTRAINT OPERACAO_RENDA_FIXA_COMPROMISSADA_FK_OPERACAO  FOREIGN KEY (ID)
...
(
    ...
    CONSTRAINT OPERACAO_RENDA_FIXA_COMPROMISSADA_LASTRO_FK_INSTRUMENTO_FINANCEIRO               FOREIGN KEY (INSTRUMENTO_FINANCEIRO)
        REFERENCES GESTAO_RECURSOS_FINANCEIROS.INSTRUMENTO_FINANCEIRO (ID)
