-- CREATE SEQUENCE --
CREATE SEQUENCE GESTAO_RECURSOS_FINANCEIROS.OPERACAO_FINANCEIRA_SEQ MINVALUE 1 START WITH 1 INCREMENT BY 1;
...
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_FINANCEIRA.INSTITUICAO_CNPJ
    IS 'CNPJ da instituição.';
COMMENT
...
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_FINANCEIRA.INSTRUMENTO_FINANCEIRO_GIF_CODIGO
...
COMMENT
ON COLUMN GESTAO_RECURSOS_FINANCEIROS.OPERACAO_FINANCEIRA.DATA_ADMISSAO
    IS 'Data da admissão da operação financeira';
COMMENT
...
-- GRANTS --
GRANT SELECT, ALTER ON GESTAO_RECURSOS_FINANCEIROS.OPERACAO_FINANCEIRA_SEQ TO USER_GESTAO_RECURSOS_FINANCEIROS;
