...
(
    ...
    CONSTRAINT OPERACAO_RENDA_FIXA_DEFINITIVA_INDICE_EMISSAO_FK_INDICADOR_FINANCEIRO FOREIGN KEY (INDICE_EMISSAO) REFERENCES GESTAO_RECURSOS_FINANCEIROS.INDICADOR_FINANCEIRO(ID),
